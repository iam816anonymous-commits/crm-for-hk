...
import {
  ...
  GitCompare, BarChart3, Settings, Search, Bell, Plus
} from 'lucide-react';
    ...
    <div className="flex h-screen bg-gray-100 font-sans antialiased">
      ...
      <aside className="w-64 bg-slate-900 text-white flex flex-col shadow-xl z-20">
        ...
        <div className="p-4 border-t border-slate-800 flex items-center space-x-3">
          <div className="w-9 h-9 rounded-full bg-blue-500 flex items-center font-bold text-white justify-center text-sm">
            RK
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-white truncate">Ravi Agent</p>
            <p className="text-xs text-slate-400 truncate">agent@propcrm.com</p>
          </div>
        </div>
      </aside>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 z-10 shadow-sm">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white px-3.5 py-2 rounded-lg text-sm font-medium shadow-sm transition">
